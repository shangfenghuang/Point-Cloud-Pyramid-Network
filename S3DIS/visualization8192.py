...
parser.add_argument('--num_point', type=int, default=8196, help='Point number [default: 4096]')
parser.add_argument('--model_path',default='./log_8192_rgb/best_model_epoch_215.ckpt', help='model checkpoint file path')
parser.add_argument('--dump_dir', default='./result_8192', help='dump folder path')
